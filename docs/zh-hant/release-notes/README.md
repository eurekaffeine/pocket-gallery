...
- 修復了「喵喵 (伽勒爾的樣子)」招式缺失的問題
- 修復了「狙射樹梟 (洗翠的樣子)」種族值錯誤的問題
- 「隊伍編輯」支持自定義寶可夢名稱
- 修復了一些其他問題
...
#### 1.2.2
- 在「對戰資料」頁面中新增了「能力值計算」和「個體值計算」功能
- 修復了一些問題

#### 1.2.1
- 在「對戰資料」頁面中新增了「攻擊盲點」和「防禦盲點」功能
- 修復了一些問題

#### 1.2.0
- 在「對戰資料」頁面新增「屬性克制」和「屬性傷害」功能
- 修復了一些問題
