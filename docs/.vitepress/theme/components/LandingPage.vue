        ...
        <div class="pg-phone-column">
          <div class="pg-phone">
            ...
            <div class="pg-phone-screen">
              ...
              <div class="pg-demo-head"><strong>{{ activeFeature === 4 ? 'Lumiose City' : activeFeature === 3 ? 'Team Builder' : activeFeature === 2 ? 'Battle Tools' : 'Pocket Gallery' }}</strong><span>•••</span></div>
              <div v-if="activeFeature === 0" class="pg-screen pg-dex">
                <div class="pg-search">⌕ <span>Search Pokémon</span></div><div class="pg-red-pill">National Pokédex</div>
