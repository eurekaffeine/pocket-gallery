...
- Added data for the "Z-A Hyper Dimension Surge" DLC
- Fixed some issues
...
- Adapted for iOS 26 and iPad OS 26

#### 1.3.0

- Added "Team Editing" feature to the "Battle Info" page
- Fixed some issues
...
- Updated some official artworks
- Fixed some issues
...
- Fixed crashes, lag, and other issues.
- Resolved compatibility issues with iOS 17
